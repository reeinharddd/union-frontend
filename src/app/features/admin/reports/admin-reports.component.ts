  ...
  template: `
    <div class="p-6">
      <div class="mb-6 flex items-center justify-between">
        <h1 class="text-gray-900 text-2xl font-bold">Reportes del Sistema</h1>
      </div>

      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div class="rounded-lg bg-white p-6 shadow">
          <h3 class="mb-2 text-lg font-semibold">Reportes de Usuarios</h3>
          <p class="text-gray-600 text-sm">Estadísticas y reportes sobre usuarios del sistema</p>
          <button
        ...
        <div class="rounded-lg bg-white p-6 shadow">
          ...
          <p class="text-gray-600 text-sm">Reportes de contenido inapropiado y moderación</p>
          <button
        ...
        <div class="rounded-lg bg-white p-6 shadow">
          ...
          <p class="text-gray-600 text-sm">Métricas de actividad y uso de la plataforma</p>
          <button
