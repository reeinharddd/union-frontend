...
export class AdminRolesComponent implements OnInit {
  ...
  ngOnInit() {
    // Los roles ya están inicializados en la declaración
  }
  ...
  viewRolePermissions(_role: Role) {
    // Aquí podrías mostrar un modal con los permisos detallados del rol seleccionado
    // Por ahora se podría implementar la navegación a una vista detallada
    // Implementación futura para mostrar detalles del rol
  }
}
