          ...
          <div class="rounded-xl border border-border bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <p class="text-text-muted text-sm">Total Universidades</p>
                  <p class="text-text-base text-2xl font-bold">{{ universities().length }}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="rounded-xl border border-border bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <p class="text-text-muted text-sm">Activas</p>
                  <p class="text-text-base text-2xl font-bold">{{ getActiveUniversities() }}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="rounded-xl border border-border bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <p class="text-text-muted text-sm">Dominios</p>
                  <p class="text-text-base text-2xl font-bold">{{ universities().length }}</p>
                </div>
              </div>
            </div>
          ...
          <div class="rounded-xl border border-border bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <p class="text-text-muted text-sm">Total</p>
                  <p class="text-text-base text-2xl font-bold">{{ universities().length }}</p>
                </div>
              </div>
            </div>
        ...
        <div class="rounded-xl border border-border bg-white shadow-sm">
          <div class="border-b border-border p-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-4">
                <div class="relative">
                  <svg class="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                  </svg>
                  <input type="text" placeholder="Buscar universidades..." class="pl-10 pr-4 py-2 border border-border rounded-lg"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="divide-y divide-border">
            @for (university of universities(); track university.id) {
              <div class="p-6 hover:bg-neutral-50 transition-colors">
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    <div class="flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-secondary-400 to-primary-400 font-bold text-white shadow-soft">
                  ...
                  <div class="flex items-center space-x-3">
                    <span class="rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-800">Activa</span>
          ...
          @if (universities().length > 0) {
            <div class="border-t border-border p-6">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <span class="text-sm text-text-muted">Mostrando {{ universities().length }} de {{ universities().length }} universidades</span>
                </div>
