...
@Component({
  ...
  template: `
    <div class="min-h-screen hero-gradient">
      <!-- Header -->
      <header class="relative overflow-hidden bg-surface/90 backdrop-blur-sm border-b border-border">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3 animate-fade-in">
              <img src="/assets/images/logo.png" alt="UniON" class="h-10 w-auto animate-float" />
              <h1 class="text-2xl font-bold text-primary-600">UniON</h1>
            </div>
            <div class="flex space-x-4 animate-slide-in">
              <button
                (click)="navigateToLogin()"
                class="rounded-lg border border-primary-200 bg-surface px-4 py-2 text-sm font-medium text-primary-600 transition-all duration-300 hover:bg-primary-50 hover:border-primary-300 hover:shadow-soft"
              >
                Iniciar Sesión
              </button>
              <button
      ...
      <!-- Hero Section -->
      <section class="relative overflow-hidden py-20 sm:py-32 bg-grid">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="text-center animate-slide-in">
            <h1 class="text-4xl font-bold tracking-tight text-text-base sm:text-6xl">
              Conecta, Colabora y
              <span class="text-primary-600 animate-pulse-slow">Crea</span> con la
            ...
            <p class="mx-auto mt-6 max-w-2xl text-lg leading-8 text-text-muted">
              UniON es la plataforma que democratiza la colaboración académica global,
              conectando estudiantes y egresados verificados para crear proyectos innovadores
              que transforman ideas en acción concreta.
            </p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <button
                (click)="navigateToRegister()"
                class="group rounded-lg bg-primary-600 px-6 py-3 text-base font-semibold text-surface shadow-soft transition-all duration-300 hover:bg-primary-700 hover:shadow-hover hover:scale-105"
              >
                <span class="group-hover:animate-pulse">Comenzar Ahora</span>
              </button>
              <button
                (click)="scrollToFeatures()"
                class="group text-base font-semibold leading-6 text-text-base hover:text-primary-600 transition-colors duration-300"
              >
                Conocer más
      ...
      <!-- Features Section -->
      <section id="features" class="py-24 sm:py-32 bg-surface">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div class="flex flex-col feature-card p-6 rounded-xl bg-surface border border-border shadow-soft hover:shadow-hover">
                <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-text-base">
                  <div class="h-10 w-10 flex items-center justify-center rounded-lg bg-primary-600 shadow-soft">
                    <svg class="h-6 w-6 text-surface" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-text-muted">
                  <p class="flex-auto">
                    Acceso exclusivo para estudiantes y egresados con credenciales universitarias verificadas,
                    garantizando un entorno académico confiable y de calidad.
                  </p>
                </dd>
              </div>
              <div class="flex flex-col feature-card p-6 rounded-xl bg-surface border border-border shadow-soft hover:shadow-hover">
                <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-text-base">
                  <div class="h-10 w-10 flex items-center justify-center rounded-lg bg-secondary-600 shadow-soft">
                    <svg class="h-6 w-6 text-surface" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              ...
              <div class="flex flex-col feature-card p-6 rounded-xl bg-surface border border-border shadow-soft hover:shadow-hover">
                <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-text-base">
                  <div class="h-10 w-10 flex items-center justify-center rounded-lg bg-accent-600 shadow-soft">
                    <svg class="h-6 w-6 text-surface" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-text-muted">
                  <p class="flex-auto">
                    ...
                    expandiendo tu red de contactos académicos y profesionales de manera significativa.
                  </p>
                </dd>
              </div>
            </dl>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-6 text-lg leading-8 text-primary-200">
              UniON va más allá del networking tradicional, sirviendo como catalizador
              para la innovación interuniversitaria y el desarrollo profesional.
            </p>
          </div>
          <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
              <div class="flex flex-col p-6 rounded-xl bg-primary-800/50 border border-primary-700 hover:bg-primary-800/70 transition-all duration-300">
                <dt class="text-lg font-semibold leading-7 text-surface mb-4">
        ...
        <div class="px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-text-muted">
              Únete a la comunidad de estudiantes y profesionales que están creando
              el futuro de la colaboración académica.
            </p>
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6">
              <button
                (click)="navigateToRegister()"
                class="w-full sm:w-auto group rounded-lg bg-primary-600 px-8 py-3 text-base font-semibold text-surface shadow-soft transition-all duration-300 hover:bg-primary-700 hover:shadow-hover hover:scale-105"
              >
                <span class="group-hover:animate-pulse">Crear Cuenta</span>
              </button>
              <button
                (click)="navigateToLogin()"
                class="w-full sm:w-auto group rounded-lg border border-primary-200 bg-surface px-8 py-3 text-base font-semibold text-primary-600 shadow-soft transition-all duration-300 hover:bg-primary-50 hover:border-primary-300 hover:shadow-hover"
              >
                Ya tengo cuenta
                <span aria-hidden="true" class="inline-block transition-transform group-hover:translate-x-1">→</span>
              </button>
      ...
      <footer class="bg-neutral-900 border-t border-neutral-800">
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p class="text-sm text-neutral-400 text-center sm:text-right">
